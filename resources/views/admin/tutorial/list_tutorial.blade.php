                ...
                <tbody>
                    @forelse($tutorials as $tutorial)
                        <tr>
                            ...
                            <td>Support</td>
                            <td>
                                <a href="{{ route('admin.tutorial.TutorialDelete', ['id' => $tutorial->id]) }}"><button class="bt_tutorial bt_del" type="button">Delete tutorial</button></a>
                                <a href="{{ route('admin.tutorial.TutorialEdit', ['id' => $tutorial->id]) }}"><button class="bt_tutorial  bt_edit" type="button">Edit tutorial</button></a>
                            </td>
                        </tr>
                    @empty
