          ...
          <div class="col-12 col-lg-10 col-xl-8 mx-auto">
            <div class="raw">
              <div style="margin-top: 50px;">
                ...
                @endif
                <form action="{{ route('admin.users.updateEcomm', $user->id) }}" style="mt-[30px]" method="POST"
                  id="formCheckout">
                  @csrf
                    ...
                    <div class="block-info-form">
                      ...
                      <div class="box-form-imputs">
                        ...
                        <div class="line-info-form">
                          ...
                          {{-- IMPUT --}}
                          <div class="column-form2">
                            <input class="new-inputs" name="username" type="text" value="{{ $user->username }}"
                              required>
                          </div>
                          {{-- ALERT --}}
                          <div class="column-form3">
            ...
            <div class="raw">
              <div style="margin-top: 50px;">
                ...
                <form action="{{ route('admin.users.updateSecondAddressEcomm', $user->id) }}" style="mt-[30px]"
