...
@section('content_header')
  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1> <a href="{{ route('admin.packages.filterBycountry.country') }}" class="btn btn-md bg-warning">
            Back</a></h1>
      </div>
      <div class="col-sm-6">
  ...
  <div class="row d-flex justify-content-center ">
    <div class="col-lg-12">
      <div class="card card">
        ...
        <form action="{{ route('admin.packages.filterBycountry.country.selected') }}" method="POST"
          ...
          <div class="row">
            <div class="col-md-12" style="display: flex; justify-content:start;padding-left:1rem;gap:1rem">
              <label for="commission">Country</label>
              <input type="text" class="form-control form-control-lg" id="tax" name="country"
                style="width: 30%;height: 2rem;" value="{{ $country->country }}" required readonly>
