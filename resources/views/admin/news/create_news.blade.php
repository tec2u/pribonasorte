    ...
    <div class="row d-flex justify-content-center ">
        <div class="col-lg-6">
            <div class="card card-primary">
                ...
                <form action="{{ route('admin.news.CreatePostNews') }}" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        <div class="col md 12">
                            <div class="form-group">
                                <label for="name">Title</label>
                                <input type="name" class="form-control form-control-lg @error('name') is-invalid @enderror" id="name" name="title" placeholder="Enter Title" value="{{ old('name') }}">
                                @error('name')
                        ...
                        <div class="col md 12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" id="name" name="resume" placeholder="Resume News">
                            </div>
                        </div>
