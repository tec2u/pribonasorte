                    ...
                    <div class="col-12">
                        ...
                        <div class="card shadow my-3">
                            <div class="card-header bbcolorp">
                                <h3 class="card-title">HIGHEST CAREER</h3>
                                <a href="{{ route('reports.teamrankscurrent') }}"><button style="float: right;">CURRENT CAREER</button></a>
                            </div>
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        @forelse ($rankteam as $team)
                                            ...
                                            @php
                                            $id_user    = $team->id;
                                            $career     = Illuminate\Support\Facades\DB::select("SELECT * FROM career_users WHERE user_id = '$id_user' ORDER BY career_id DESC");
