        ...
        <div class="col-12 col-sm-6 col-md-3">
              ...
              <div class="info-box mb-4 shadow elevation c1 box-info box-career">
                ...
                <div class="d-flex">
                  ...
                  <div
                    ...
                    <span>{{ $soma }}</span>
                    <span>----</span>
                    <span>{{ $proximaCarreira->volumeRequired }}</span>
                  </div>
                </div>
              @else
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      @foreach ($pontosPorUser as $item)
                        @if (isset($item))
                          <tr>
                            <td>{{ isset($item->userFrom->name) ? $item->userFrom->name : '' }}
                              {{ isset($item->userFrom->last_name) ? $item->userFrom->last_name : '' }}</td>
                            <td></td>
                            <td></td>
                            <td>{{ isset($item->total) ? $item->total : 0 }} QV</td>
                          </tr>
                        @endif
                      @endforeach
                        ...
                        @if (isset($item))
                          ...
                          <tr>
                            <td>{{ isset($item->name) ? $item->name : '' }}
                              {{ isset($item->last_name) ? $item->last_name : '' }}</td>
                            <td></td>
                            <td></td>
                            <td>{{ isset($item->career) ? $item->career : '' }}</td>
                          </tr>
                          {{-- @endif --}}
                        @endif
                      @endforeach
          ...
          {{-- <div class="col-12">
              <div class="Container-carousel">
                <h3 class="Head-carousel">Products <span class="Arrows"></span></h3>
                <!-- Carousel Container -->
                <div class="SlickCarousel">

                  @foreach ($products as $item)
                    <!-- Item -->
                    <a href="{{ route('packages.detail_products', $item->id) }}">
                      <div class="ProductBlock">
                        <div class="Content">
                          <div class="img-fill">
                            <img src="/img/products/{{ $item->img_1 }}">
                          </div>
                          <h3>{{ $item->name }}</h3>
                        </div>
                      </div>
