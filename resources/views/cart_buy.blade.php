...
@section('content')
  ...
  <script>
    ...
    document.getElementById('button-buy').addEventListener('click', () => {
      meuForm = document.getElementById('form-checkout-backoffice');
      meuForm.action = "{!! route('packages.cartFinalize') !!}";
    })
    ...
    function alterarValor(valor) {
      ...
      let myAdress = document.getElementById('formHome1');
      if (valor == 'home') {

        myAdress.style.display = 'flex';
        ...
        document.getElementById('shipping_table').innerHTML = {{ number_format($priceShippingHome, 2) }};
    ...
    function submitCheckout(e) {
      ...
      if (document.getElementById('cell').value == null || document.getElementById('cell').value == '') {
