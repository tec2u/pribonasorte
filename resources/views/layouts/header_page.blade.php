    ...
    <div class="container" id="nav-container">
      ...
      <nav class="navbar navbar-expand-lg fixed-top" id="navbar-top">
        ...
        <div class="collapse navbar-collapse justify-content-space-evenly"
          style="width: fit-content; justify-content: space-between;">
          <ul class="btns-header"
            style="padding-left: 0px; display:flex; flex-wrap: nowrap; margin-right: 10px; justify-content: center;">
            <li style="display: flex">
              <i class="fa-solid fa-magnifying-glass" id="btn-search-toggle-in"
                style="color: #ffffff; font-size: 15px; cursor: pointer;"></i>
              <i class="fa-solid fa-magnifying-glass" id="btn-search-toggle-out"
                style="color: #ffffff; font-size: 15px; cursor: pointer;"></i>
            </li>
            <li> <a href="{{ route('index.cart') }}"> <i class="fa-sharp fa-solid fa-bag-shopping"
                  style="color: #ffffff; font-size: 20px;"></i></a></li>
          </ul>
          {{--  --}}
