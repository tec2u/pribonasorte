        ...
        <div class="right2">
          ...
          <div>
            ...
            @else
              <p>
                <br>
                {{ $data['address'] }} - {{ $data['number'] }} {{ $data['complement'] ?? '' }} <br>
                {{ $data['neighborhood'] }}, {{ $data['zip'] }} - {{ $data['country'] }}
              </p>
            @endif
          </div>
        </div>
      ...
      <div class="section-3">
        ...
        @foreach ($data['products'] as $item)
          ...
          <div class="middle">
            ...
            <span>{{ $item['unit'] }}</span>
            {{-- <span>21%</span> --}}
            <span>{{ ($item['vat']/$item['unit'])*100 }}%</span>
        ...
        <div class="bottom border">
          <div>
            <span class="" style="width: 50%">Total Amount</span>
            <span class="" style="width: 20%">{{ $data['total_price_product'] }}</span>
            <span class="" style="width: 15%">{{ number_format($data['total_vat'], 2, ',', '.') }}</span>
            <span class="" style="width: 15%">{{ $data['total_order'] - $data['total_shipping'] }}</span>
          </div>
