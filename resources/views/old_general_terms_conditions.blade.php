      ...
      <div class="container" style="padding: 50px 10%;">
        ...
        <div class="line-content">
          <p class="text-content">1.1.1 The Pribonasorte Group consists of the company INTERMODELS s.r.o., Pod Nouzovem
            ...
            Distributors, establish requirements for the Distributors' dealings with customers, for the Distributors'
            ...
            Distributor does not agree to the changes, modifications or expansion of the terms, he is entitled to reject
            them and terminate the contractual relationship with the Company without notice.
            <br />
            <br />
            1.1.6 The Company is entitled to unilaterally assign the contractual relationship with the Distributor, as
            well as all related rights and obligations, both existing or future, to any third party. By accepting these
            Rules, the Distributor grants explicit consent to the Company for this action. The fact that there has been an
            assignment of the contractual relationship will be notified to the Distributors through one of the Company's
            officially used communication channels or by an appropriate change to these Rules, by accepting which the
        ...
        <div class="line-content">
          ...
          <p class="text-content">
            ...
            reason.
            <br><br>
            1.2.4 In case of successful completion of registration in the Company's system, a confirmation of receipt of
            registration is sent to each Distributor's e-mail address together with login details for his newly created
            account in the system on the Company's web interface (hereinafter referred to as " Account "). Distributors
            are advised to change their access password as soon as possible after logging in to ensure the security of
            their data and information in their Account.
            <br><br>
            1.2.5 Acceptance of registration in the Company's system creates membership, i.e. a contractual relationship
            between the Company and this registered member - Distributor. This contractual relationship is fully governed
            by these Rules, including all related attachments and documents.
            <br><br>
            1.2.6 Each newly registered Distributor is assigned a unique ID number (hereinafter referred to as " ID ").
            This ID is used by each Distributor to identify himself, communicate with the Company and other Distributors,
            and through it, the Distributor is enabled to log into and manage his Account.
            <br><br>
            1.2.7 Each Distributor is obliged to fill in valid and true personal data, delivery address and billing data
            in the Account settings. Each billing address can only be listed once in the Company's system. It is strictly
            ...
            damage incurred by the Distributor in connection with the unauthorized transfer or disclosure of his Account
            to other persons.
            <br><br>
            1.2.9 In the event that missing, incomplete, incorrect or fraudulent information is additionally found in the
            registration form, or it is found that it is a duplicate registration of the same person, the Company is
            entitled to cancel such registration, the created Account and the assigned ID at any time without compensation
            .
            <br><br>
            1.2.10 Each Distributor may be assigned only one ID. These Rules may provide for exceptions that temporarily
            allow a Distributor to be assigned multiple IDs. In the case of unauthorized possession of multiple IDs, the
            Company is entitled to cancel each duplicate registration and associated Account and assigned ID at any time
            without compensation and retain only the first registration, associated Account and Distributor ID, unless the
            ...
            <br><br>
            1.2.12 By completing the registration, the Distributor voluntarily provides the Company with his personal and
            contact information required during registration for the purpose of concluding a contractual relationship with
            the Company, properly fulfilling the rights and obligations arising from this relationship, fulfilling legal
            obligations and protecting the rights and legitimate interests of the Company. Personal data is information
            leading to the identification of an individual (e.g. first and last name, permanent residence, telephone
            contact, e-mail address, etc.). With the consent of the Distributor, the Company also processes personal data
            for marketing and other purposes. More detailed information on the processing of personal data is provided in
            the appendix to these Rules. The company fully respects the privacy of each Distributor and is also aware of
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            <br><br>
            1.3.2 The Distributor is not authorized to legally act on behalf of the Company, represent it, bind it to any
            performance, make statements on its behalf or provide any guarantees on its behalf, unless authorized to do so
            by the Company by a special power of attorney. In particular, the Distributor is not authorized to enter into
            any contracts on behalf of the Company, accept claims or payments.
            <br><br>
            1.3.3 The main purpose of the contractual relationship between the Company and the Distributor is to mediate
            the sale of Products to third parties and to develop activities aimed at expanding the Company's business
            network. At the same time, the Distributor is authorized to purchase Products for his own consumption for this
            purpose. The Distributor is not authorized to resell the Products commercially. The distributor performs this
            activity on his own behalf and under his own responsibility. The distributor is obliged to secure all relevant
            ...
            markets or countries where the Company does not yet officially operate, he is obliged to make sure in advance
            that this activity is permitted in the given location and he is also obliged to comply with the given rules
            for labeling The product and its claims. The Company is not responsible for the actions of the Distributor,
            ...
            <br><br>
            1.3.7 The Distributor authorizes the Company to issue tax documents (invoices) for services provided to the
            Company according to the Company's compensation plan. If the law requires, in the case of a Distributor who is
            a value added tax payer, the granting of a power of attorney in another prescribed form, such Distributor is
            obliged to deliver the power of attorney in the prescribed form to the Company. The Distributor is obliged to
            accept the Company's assigned accounting series and the prescribed variable symbol. The Distributor is not
            authorized to make changes to the amounts shown on these invoices. All invoices are issued in electronic form.
            <br><br>
            1.3.8 The Distributor is obliged to keep proper accounting records and keep accounting and tax documents for
            the period required by applicable legal regulations in the case of conducting business activities.
            <br><br>
            1.3.9 The Company does not guarantee territorial exclusivity to any Distributor. The Distributor is also not
            entitled to offer such exclusivity to new Distributors. Equal conditions apply to all Distributors without
        ...
        <div class="line-content">
          <p class="text-content">
            1.4.1 A Distributor becomes a sponsor at the moment when the registration of a new Distributor who entered his
            ID as his sponsor in the registration form is completed.
            <br><br>
            1.4.2 Each newly registered Distributor has the right to choose his sponsor, to whose structure he will
            ...
            promptly, positively and on a friendly level. The sponsor also monitors compliance with the principles and
            principles of these Rules for all members of its downline group to the best of its ability. In the event that
            the sponsor is unable to resolve the dispute within his competence, he will turn to his upline and, in serious
            cases, directly to the Company, which will provide all available and true information and documents leading to
            a successful resolution of the dispute. Sponsors in middle and higher career positions are role models and
            lead by example for new or less experienced Distributors, especially in these crisis situations.
            <br><br>
            1.4.7 Each Distributor chooses his sponsor already before becoming a member as part of the registration in the
        ...
        <div class="line-content">
          <p class="text-content">
            2.2.1 The Distributor undertakes to comply with the relevant ethical, professional and moral standards that
          ...
          <ul>
            ...
            <li>
              not to undercut Products to potential customers solely for the purpose of own profit, regardless of the
            ...
            <li>
              recommend to a person known to him that he may have health complications to consult a doctor before using
              the Products,

            </li>
            <li>
              actively resolve all complaints or misunderstandings with customers and, in justified cases, request the
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            The system of purchase of Products by Distributors is set up in such a way that it assumes the purchase of
            Products only for the Distributor's and his immediate family's own consumption, the previous consumption of a
            larger part of the previously purchased Products and does not count on excessive purchases by Distributors
            ...
            There is no reserved area or territory for the activities of the Distributor. The distributor is therefore not
            ...
            The Company does not approve of the Distributor, with the intention of building his own downline group,
            systematically targeting members of another company using the network marketing method and for this purpose
            encouraging them to violate the terms of cooperation with this company. The Company is not responsible for
            such actions of the Distributor.
            <br><br>
            2.3.13 Approval of Prohibited Conduct
            Any Distributor who witnesses a deliberate violation of these Rules is obliged to report this fact to his
            sponsor and, if this is not possible, to the Company directly. Approval of intentional violations of these
            Rules is prohibited.
            <br><br>
            2.3.14 Providing and spreading false information
            Any action by the Distributor leading to a reduction of trust in the Company's management, in particular the
            provision or dissemination of false information or the dissemination of false hoaxes (e.g. on Telegram,
            Whatsapp etc.) is considered a violation of the Rules with all the consequences thereof. A Distributor who
            commits the described behavior may have his membership terminated by the Company immediately, even without
            prior notice.
            <br><br>
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            Registration without a purchase is considered an incomplete registration, which does not bind the member to
            the first sponsor and their registration.
            <br><br>
            3.1.4 A member of the statutory body of a legal entity who is already a registered Distributor cannot be a
            Distributor at the same time. On the other hand, a legal entity whose member of the statutory body is already
            a registered Distributor cannot become a Distributor. Any such or similar chaining of distributors is not
            permitted and will be considered a duplicate registration, which the Company is entitled to cancel along with
            the created Account and assigned ID at any time without compensation.
            <br><br>
            3.1.5 It is strictly forbidden to enter the same billing information for multiple Accounts. In the event that
            the Company discovers such conduct, it is entitled to cancel all Accounts with assigned IDs that contain the
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            marriage, etc. A Distributor who requests consent to transfer membership is obliged to properly justify the
            request and substantiate it with relevant documents and the consent of the new Distributor.
            <br><br>
            3.2.4 All rights and obligations resulting from the contractual relationship with the Company are transferred
            ...
            regulation in the transformation project is decisive for determining the transfer of membership. In case of
            doubt, the Company continues and recognizes as a Distributor a person who has the same ID number as the
            current Distributor. It is not allowed to divide or multiply one ID to several people.
            <br><br>
            3.2.6 The fact that the membership has been transferred does not affect the individual links in the structure
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            <br><br>
            3.3.2 The heir or legal successor of the Distributor is obliged to prove the legal succession to the Company
            ...
            Distributor, provided that the transition has been successfully completed in the Company's system and the new
            Distributor is able to meet the requirements specified in the Company's compensation plan.
            <br><br>
            3.3.5 If there are more legal successors, they are obliged to appoint a representative among themselves who
            will become the Distributor. The Company will continue to deal legally only with and towards this person. It
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            If the Company discovers or suspects that the Distributor has violated the obligations arising from these
            Rules, related annexes or documents, but the Company has not yet taken a decision on whether to terminate the
            membership of this Distributor, the Company is entitled until the adoption of this decision, but no longer
            than 2 months, limit or completely deny this Distributor access to his Account. During this transitional
            period, the payment of commissions or any other financial payments to the Distributor is also suspended. In
            the event that the Company subsequently decides to continue the membership of this Distributor, it will
            restore access to the Account and the Distributor will be entitled to payment of suspended commissions and
            other payments. However, if the Company decides to terminate the membership of this Distributor, The
            Distributor's account will be canceled without making it available again, and the Distributor will not be
            entitled to payment of suspended commissions or further performance. The Company will send the notification
            that access to the Account has been restricted or blocked and the payment of commissions has been suspended,
            ...
            A Distributor whose membership has been terminated by the Company for breach of duty pursuant to clause 3.4.3
        ...
        <div class="line-content">
          <p class="text-content">
            4.1.1 The Distributor is entitled to purchase Products for own consumption at discounted prices. The company
            is entitled to unilaterally change the prices of individual Products at any time without any prior notice. Any
            change in the price of the Products is immediately effective from the moment the change is reflected in the
            relevant distribution channel of the Company. In the event that the price of the Product is listed in an
            obviously incorrect manner, the Company is entitled to cancel the orders made containing such an incorrect
            Product price at any time, regardless of the payment of the order.
            <br><br>
            4.1.2 The Distributor orders Products only online through the Company's official e-shop, after logging in to
            his Account in the system on the Company's web interface. Orders can be placed at any time outside of lockouts
            or scheduled updates.
            <br><br>
            4.1.3 Each purchased Product has its own point value (PV), which is intended for calculating the amount of
            commissions and other rewards, under the conditions resulting from the Company's compensation plan. The
            Company is entitled to unilaterally change the point value of the Products at any time without any prior
            notice.
            <br><br>
            4.1.4 The standard deadline for sending the ordered Products is 5 working days from the date of payment of the
            ...
            information necessary for its processing, the ordered Products are not currently in stock, or another fact
            occurs that prevents the proper processing of the order, the Company is entitled to delay the order or not to
            process it, until removal of such an obstacle. The company deals with such situations individually according
            to the circumstances of the given case. If an obstacle to the fulfillment of the order is a fact for which the
            Distributor is responsible and the latter does not remove it even after prior notification by the Company, the
            Company is entitled to bill the Distributor for the increased costs of fulfilling such an order.
            <br><br>
            4.1.6 Ownership of the ordered Product is transferred to the Distributor upon its acceptance after full
            payment of its price. Payment of the price of the entered order can be made by bank card or transfer. In the
            ...
            ordered Products and to order additional Products in an amount commensurate with their planned consumption in
            order to avoid excessive purchases.
            <br><br>
            4.1.8 Products, including their price, are only available for the time they are displayed on the web interface
            of the Company's e-shop. In the event that the ordered Product is no longer available or is not being
            delivered or manufactured, the Company will immediately contact the Distributor in order to arrange the next
            procedure. In such a case, the company is also entitled to refuse or cancel the order.
            <br><br>
            4.1.9 Before sending the order, the Distributor is allowed to check and confirm the data he entered in the
            order. The distributor can cancel the order to the moment the order is sent, by phone or email. This does not
            ...
            expresses his consent to the provision of personal data and their subsequent processing by the Company for the
            purpose of creating and archiving anonymous data records from information obtained by testing and analyzing
            the dried blood spot test and from survey questionnaires excluding sensitive personal information (names,
            dates of birth, residence) that would make the data personally identifiable. This information will be used by
            OmegaQuant Analytics, LLC, a South Dakota limited liability company, which guarantees data protection.
            https://omegaquant.com
            The distributor acknowledges that this anonymized data will be used for statistical data analysis, further
            research and publication of research results (especially at conferences, lectures, interviews, websites, TV
            shows, magazines, etc.). At the same time, the Distributor agrees to participate in the Company's research and
            accepts all the Company's conditions regarding the isolation and archiving. The Omega quant will use the
            distributor's anonymized data for the purpose of processing research studies.
            <br><br>
            4.1.11 When entering an incorrect ID for a sent order, the Distributor may request correction and correction
            of commissions or other rewards associated with the sent order only on the same calendar day when the order
        ...
        <div class="line-content">
          <p class="text-content">
            4.3.1 The Distributor can also use the option of the so-called automatic order for taking the Products, which
            enables automatic repetition of the entered order at selected time intervals. This option is particularly
            suitable for Distributors who are interested in regular replenishment of Products for personal consumption.
            <br><br>
            4.3.2 Payment for each automatic order will be debited from the bank card or from the bank account of the
            Distributor, according to the specified choice, before dispatch of the ordered Products.
            <br><br>
            4.3.3 If it is not possible to make a payment for an automatic order (for example, due to an insufficient
            balance on the distributor's bank card or bank account) or if the payment is refused, the ordered Products
            will not be sent. The Company will inform the Distributor about this fact.
            <br><br>
            4.3.4 In the event that an automatic order cannot be made, the Company is entitled to change the payment
            method to another option added by the Distributor when placing an automatic order, in the order specified by
            the Distributor.
            <br><br>
            4.3.5 The Distributor is entitled to cancel the automatic order at any time through a change in the Product
            order settings.
        ...
        <div class="line-content">
          <p class="text-content">
            4.4.1 When placing an order, the Distributor will state the delivery address and specify the shipping option.
            The price of the selected transport will be added to the price of the ordered Products.
            <br><br>
            4.4.2 In the event that the Distributor does not properly take over the ordered Products from the carrier, he
            bears the costs of re-delivering such a shipment, or The company is entitled to bill these costs to the
            Distributor.

            <br><br>
            4.4.5 The Company is not responsible for the delivery of the ordered Products in the event of entering an
            incorrect delivery address. In the event that it is not possible to deliver the ordered Products to the
            delivery address specified by the Distributor and the shipment is returned, the Company is entitled to
            withdraw from the contract that arose on the basis of the order for the Products in question, which the
            Distributor will be informed of in writing to the e-mail address specified in the order.
            <br><br>
            4.4.6 The distributor is obliged to report damaged shipments, missing or unordered items no later than 5
            working days from the date of delivery of the shipment.
            <br><br>
            4.4.7 The distributor acknowledges that the shipping price does not include additional fees, customs duties,
            taxes or other mandatory payments when the shipment is delivered abroad. The amount of these costs is
            individually regulated by the laws of the country to which the shipment is delivered. These costs are always
            ...
            Distributor, or his representative. From this moment on, the Distributor is obliged to secure the delivered
        ...
        <div class="line-content">
          <p class="text-content">
            4.5.1 The Company is responsible to the Distributor for ensuring that the Product is free of defects upon
            receipt. This means that the Product has the quality and useful properties required by the contract or
            described by the Company, or expected on the basis of the advertising carried out by the Company, or the
            quality and useful properties for a product or service of this kind are usual, that it meets the requirements
            of legal regulations, is in the corresponding amount, measure or weight and corresponds to the purpose that
            the Company states for the use of the Product or for which such product or service is usually used.
            <br><br>
            4.5.2 The Distributor is obliged to inspect the delivered Product as soon as possible after taking it over (no
            later than 24 hours after taking it over) and make sure of its properties and quantity. The Distributor is
            obliged to report any obvious defect without undue delay (no later than 24 hours after taking over the goods),
            otherwise the Company's responsibility for obvious defects ceases.
            <br><br>
            4.5.3 The distributor does not have the right from defective performance, if the defect in the Product was
            already apparent when it was taken over and the Distributor must have known about it, or he caused the defect
            himself.
            <br><br>
            4.5.4 The minimum shelf life date of the Product, which is indicated on each Product packaging, is also a
            guarantee of quality if the conditions for its storage are observed. Damage (mechanical, improper storage,
            etc.) is not a defect of the Product.
            <br><br>
            4.5.5 Complaints are made in writing, stating the date of delivery of the goods, the number of the relevant
            invoice, the type of goods, the label from the goods packaging, the batch number, the claimed quantity, a
            description of the defect supplemented by photographic documentation stating the Distributor's request for
            processing the claim and the Distributor's contact details, including e -email, together with the claimed
            ...
            Zásilkovna or other courier companies to the address see contacts for returning products. If the claim is
            delivered via a courier service or its sponsor, the company is not responsible for loss or damage to the
            shipment during transit. The company does not take delivery of the claimed Product on cash on delivery.
            <br><br>
            4.5.7 The Distributor is always obliged to ensure suitable packaging of the Products to avoid damage during
            transport. The company is not responsible for any damage during shipping.
            <br><br>
            4.5.8 Complaints are not admissible in the event that the defect or damage to the Product arose as a result of
            improper use of the Product in violation of the relevant instructions or instructions, or other obviously
            improper handling. Differences in color shades on electronic display devices compared to reality cannot be
            considered a defect either.
            <br><br>
            4.5.9 The deadline for processing a claim is 30 days from the date of delivery of the claim with all the
            necessary information to the Company. In justified cases, the deadline for settlement by the Company may be
            extended. The Distributor will be informed about this in writing to the e-mail address specified in the
            complaint in accordance with Article 4.5.5 of the Rules.
            <br><br>
            4.5.10 The Company decides on the method of settlement of the complaint. The latter subsequently informs the
            Distributor about this via the e-mail that he provided when making a claim in accordance with Article

            <br><br>
            4.5.11 The company also decides in which cases it reimburses the Distributor for costs incurred in connection
            with the application of a complaint.
            <br><br>
            4.5.12 In the event that the price of the purchased Product is returned to the Distributor as a result of a
            claim, the points (PV) credited for this purchased and returned Product will be automatically deducted from
            the Distributor. If the Distributor has already received payment of a commission or other form of performance
            from the Company in connection with these points (PV), he is obliged to return such commission, performance or
            parts thereof to the Company. In the event of this settlement, the Company is entitled to offset this claim
            against the Distributor's claim for the payment of additional commissions or other performance, or to take
            ...
            <br><br>
            4.5.14 The Distributor's other rights and obligations regarding complaints are set out in the Complaints
            Regulations.
        ...
        <div class="line-content">
          <p class="text-content">
            4.6.1 The Distributor acknowledges that most of the Products are food supplements subject to the relevant
            legislation. All labels on these Products are approved and notified by the Ministry of Agriculture of the
            Czech Republic, and it is therefore strictly prohibited for the Distributor to create its own labels,
            packaging or marketing materials in relation to the Products. The Distributor is also not authorized to create
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            Parliament and of the Council (EC) No. 1924/2006 of 20 December 2006 on nutrition and health claims in food
            labeling and Regulation (EU) No. 1169/2011 of the European Parliament and of the Council of 25 October 2011 on
            ...
            is authorized to do so only with the express consent of a senior sponsor. The Distributor is obliged to
            ...
            low, or close to zero, then your commission will be zero as well. All your turnover is thus dependent on your
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            <br><br>
            5.2.3 The distributor is obliged to keep proper accounting or tax records as part of his business activity and
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            <br><br>
            5.3.4 The Distributor is not authorized to use or install any unofficial vehicle decals, business cards,
            letterheads or other advertising materials that have not been approved in writing by the Company in advance.
            All current graphic materials and manuals are available in the document storage section within the Account.
            <br><br>
            5.3.5 The Company is not responsible for the content of advertising materials and any promotional items that
            it has not created or approved in advance in writing. All responsibility for the content and distribution of
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            Heureka.cz, Zboží.cz, Hledejceny.cz, advertising servers (Bazoš, Hyperinzerce, Annonce, Sbazar,Advertising
            groups on social networks, etc.), third-party sales platforms (e.g. Amazon, Alibaba, Allegro,Cdiscount,OnBuy)
            or auction sites (eBay).
            <br><br>
            5.4.6 Furthermore, the distributor may not create or enter advertising on television, print advertising
            (advertisements, ads, promotional leaflets), light advertising, radio spots, mobile advertising (e.g. on means
            ...
            threatening, vulgar or otherwise undesirable in connection with the mediation of the sale of Products, or that
            could result in civil, administrative or criminal liability.
            <br><br>
            5.4.8 When mediating the sale of Products, the Distributor is obliged to respect the right to privacy of all
            natural persons and to provide adequate protection for their personal data.
            <br><br>
            5.4.9 The Distributor may not directly or indirectly send mass, unsolicited e-mails to persons with whom it
            ...
            establishments (e.g. gyms, hairdressers or offices), exhibitions, markets, expositions or other public forums
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            Facebook, etc.), i.e. one social network = one profile. Multiple profiles managed by the same Distributor, or
            associated with the same ID, is prohibited and a violation of this provision will be considered a violation of
            the Rules with all the consequences thereof. Likewise, it is strictly forbidden to mention clicks on other
            ...
            therapeutic effects of the Products that are in violation of the relevant legal regulations (in particular
            Regulation of the European Parliament and of the Council (EC) No. 1924/2006 of 20/12/2006 on nutrition and
            health claims in food labeling and Regulation of the European Parliament and Council (EU) No. 1169/2011 of
            October 25, 2011 on the provision of food information to consumers).
            <br><br>
            5.5.7 The Distributor is not entitled to indicate a higher than recommended dosage of the Product and is
            obliged to indicate that this recommended amount applies to the use of one Product per day. In the case of
            ...
            screenshots.
            <br><br>
            5.5.9 It is strictly prohibited for the Distributor to hold any competitions on the Profile in which it offers
            Products as prizes.
            <br><br>
            5.5.10 Distributors work only with influencers who have a good reputation. Cooperation with influencers who
            have violated in the past, or they are now breaking the law, especially if they don't label advertising,
            engage in unfair competition, etc.
            <br><br>
            5.5.11 Distributors are prohibited from establishing cooperation with influencers through marketing platforms
            such as („BarterMe“ https://barterme.io/ etc.)

            <br><br>
            5.5.12 Paid cooperation of Distributors with influencers is strictly prohibited, or can only be established if
            the given influencer is registered with the Company as a Distributor. In the event that an influencer, who is
            not a registered member of the Company, conducts a paid campaign in favor of a registered member, this will be
            considered a violation of the Rules by this Distributor, with all the consequences resulting from this.
            <br><br>
            5.5.13 Cooperation with influencers in the form of so-called barter is strictly prohibited. Violation of this
            clause shall be deemed to be a violation of these Rules with all the foreseeable consequences.
            <br><br>
            5.5.14 The Distributor is obliged to protect the good name and reputation of the Company and settle all
            possible claims of the influencer arising from their mutual cooperation. In the event that the influencer
            damages the good name and reputation of the Company in any way, the Distributor is obliged to provide all
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            question. All use of registered names is possible only in accordance with these Rules or on the basis of prior
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            <br><br>
            7.1.3 The Company does not guarantee one-time or get-rich-quick, but offers its Distributors the opportunity
            to participate in a work system in which the Distributor's earnings depend on the work effort, time and
        ...
        <div class="line-content">
          <p class="text-content">
            ...
            referred to the Company for resolution. The company has the authority to make a final decision on such a
            dispute without the possibility of further appeal or judicial review.
            <br><br>
            9.1.3 When deciding a dispute, the company is based on the information and documents submitted by both parties
            to the dispute. The company is entitled to proceed with the decision of the dispute in the way it considers
            appropriate.
            <br><br>
            ...
            obligation not expressly arising from these Rules, with the determination of the consequences of failure to
            fulfill the obligation thus imposed. Failure to respect the Company's decision is considered a violation of
        ...
        <div class="line-content">
          <p class="text-content">
            9.2.1 The invalidity or ineffectiveness of any provision of these Rules or part thereof does not constitute
            the invalidity or ineffectiveness of other provisions of the Rules or their annexes and related documents.
            <br><br>
            9.2.2 These Rules may be drawn up in multiple language versions. In case of deviations between individual
            language versions, the version in the English language takes precedence, and if this version is not available
            to the Distributor or if the Distributor does not have knowledge of the Czech language, the version of the
            Rules in the English language is decisive. The same rules also apply to individual annexes to these Rules and
            related documents.
            <br><br>
            9.2.3 These Rules, individual annexes, related documents, as well as the rights and obligations arising from
            them, including the rights and obligations arising from their violation, are governed by the legal order of
            the Czech Republic. The court competent to hear all disputes arising from the contractual relationship between
            the Company and the Distributor is the Municipal Court in Praze.
            <br><br>
            9.2.4 In the event of the emergence of a legal relationship with an international element, Czech law is
            applicable and the competent body for deciding disputes is the Municipal Court in Praze, Czech Republic.
            <br><br>
            9.2.5 The company is not responsible for delays or non-fulfillment of obligations due to unforeseen
            circumstances, in particular due to force majeure, strikes, riots, terrorist attacks, war, explosions, deaths,
            ...
            individual annexes and related documents, the Distributor is obliged to reimburse the Company for all related
            costs, including the costs of legal representation and court costs. The limitation period for the exercise of
            any right of the Distributor against the Company is one year from the date on which this right could be
            exercised for the first time.
            <br><br>
            9.2.8 All agreements formed on the basis of older versions of these Rules remain in force even after the
            adoption of the new version of the Rules. However, if such agreements are in conflict with the new wording of
            the Rules, the Company is entitled to terminate these agreements within a notice period of 1 month from the
            delivery of the notice to the Distributor, regardless of the agreed conditions for the termination of these
        ...
        <div class="line-content">
          <p class="text-content">
            Multi-level marketing, or also multi-level marketing or network marketing, is the designation of a branch of
            business using the method of mediating sales through a network of independent Distributors with incentive
        ...
        <div class="line-content">
          <p class="text-content">
            An independent business partner of the Company who has entered into a contractual relationship with the
            Company for the purpose of purchasing the Company's Products for their own personal consumption, support of
            physical and mental health and the possibility of taking advantage of interesting business opportunities.
          </p>
        </div>
        ...
        <div class="line-content">
          <p class="text-content">
            The end consumer and user of the Products is different from the person of the Distributor. Products are
        ...
        <div class="line-content">
          <p class="text-content">
            An entry pack of Products, by purchasing which the Distributor acquires the status of a business partner of
            the Company. There are different benefits and point value (PV) associated with the purchase of a starter pack,
        ...
        <div class="line-content">
          <p class="text-content">
            Point value assigned to Products for the purposes of calculating commissions and other rewards resulting from
        ...
        <div class="line-content">
          <p class="text-content">
            The financial amount received by the Distributor depending on the volume of Products sold, mediated by the
        ...
        <div class="line-content">
          ...
          <ol>
            <li>These terms and conditions (hereinafter referred to as " GTC " or " General Terms and Conditions ") of
              INTERMODELS s.r.o., Pod Nouzovem 971/17, 197 00 Praha, Czech Republic, are regulated in accordance with by
              the provisions of § 1751 paragraph 1 of Act No. 89/2012 Coll., Civil Code (hereinafter referred to as the "
              Civil Code ") mutual rights and obligations of the contracting parties arising in connection with or on the
            ...
            <li>Provisions deviating from the General Terms and Conditions can be negotiated in an individual purchase
              contract. Deviating provisions in the purchase contract take precedence over the provisions of the General
          ...
          <ol>
            ...
            <li>
              In the sense of these General Terms and Conditions, an entrepreneur is a natural or legal person who, on his
              own account and responsibility, carries out a gainful activity in a trade or similar manner with the
              intention of doing so consistently in order to achieve profit. An entrepreneur is also considered to be any
              person who concludes contracts related to his own business, production or similar activity or in the
              independent performance of a profession, or a person who acts on behalf of or on behalf of an entrepreneur.
              If the buyer states his identification number in the order, he acknowledges that he is considered an
              entrepreneur in the contractual relationship with the seller and the rights for entrepreneurs apply to him.
            </li>
            <li>
          ...
          <ol>
            <li>
              Information about the goods, including the prices of the individual goods and their main features, is given
              for the individual goods published in the online store.
            </li>
            <li>
              The prices of the goods published in the online store are listed including value added tax, all related fees
              and costs for returning the goods, if these goods cannot by their nature be returned by the usual postal
              route. The prices of the goods remain valid for the period during which they are displayed for the goods in
              the online store. This provision does not exclude the negotiation of a purchase contract under individually
              agreed conditions.
            </li>
            <li>
              All presentation of goods placed in the online store is for informational purposes only. The seller is not
            ...
            <li>
              ...
              The information on the costs associated with the packaging and delivery of the goods listed in the online
              store is valid only in cases where the goods are delivered within the territory of the Czech Republic. In
              the case of delivery abroad, the price may vary, which the buyer will be informed about in the last step of
              the order.
            </li>
          </ol>
          ...
          <ol>
            <li>
              The costs incurred by the buyer when using means of communication at a distance in connection with the
              conclusion of the purchase contract, in particular the costs of internet connection, the costs of telephone
            ...
            <li>
              Before sending the order, the buyer is allowed to check and change the data he entered in the order. The
              buyer then sends the order by clicking the "send order" button. The seller considers the data provided by
              the buyer in the order to be correct. The condition for the validity of the order is the completion of all
              mandatory data and confirmation by the buyer that he has read the General Terms and Conditions and the
              Complaints Procedure and that he agrees with them.
            </li>
            <li>
              Immediately after receiving the order, the seller will send the buyer a confirmation of receipt of the order
              to the e-mail address that the buyer specified in the order. This confirmation is automatic and does not
              constitute a contract. The current terms and conditions are attached to the confirmation.
            </li>
            <li>
              The purchase contract is concluded only after the seller accepts the order, when this notification is sent
            ...
            <li>
              ...
              online store, or during the ordering process, the seller is not obliged to deliver the given goods to the
            ...
            <li>
              ...
              or the buyer prevent it. It is possible to conclude the purchase contract in another language that both
              parties agree on. The concluded contract is archived by the seller in accordance with the relevant legal
              regulations for the purpose of its successful fulfillment, or for other purposes, and is not accessible to
              third parties. Information about the individual technical steps leading to the conclusion of the purchase
              contract can be seen from the ordering process in the online store, and the buyer has the opportunity to
          ...
          <ol>
            <li>
              The buyer can pay the purchase price of the goods and any costs associated with the delivery of the goods
              ...
              <ol>
                ...
                <li>We accept credit cards, Visa and MasterCard. We work in cooperation with ComGate payment gateway. That
                  will appropriately process your card details per the international safety standard. Payment is made with
                  SSL encryption, which means that no unauthorised personnel can access your card details</li>
              </ol>
            </li>
            <li>Together with the purchase price, the buyer is obliged to pay the seller the costs associated with the
              packaging and delivery of the goods in the agreed amount. Unless expressly stated otherwise, the purchase
              price also includes the costs associated with the delivery of the goods.
            </li>
            <li>
              In the case of payment via a payment gateway, the buyer follows the instructions of the relevant electronic
              service provider.
            </li>
            <li>
              In the case of non-cash payment, the buyer's obligation to pay the purchase price is fulfilled when the
              relevant amount is credited to the seller's bank account.

            </li>
            <li>
              The seller does not require any advance payment or other similar payment from the buyer. Payment of the
              purchase price before the goods are shipped is not a deposit.
            </li>
            <li>
              The sell er issues a tax document - an invoice to the buyer, which he attaches to the goods and sends it to
              the e-mail address specified in the order.

            </li>
            <li>
              The choice of delivery method is made during the order entry. The goods are then delivered to the buyer:
              <ol>
                <li>
                  to the address specified by the buyer in the order, via the carrier - Post office for orders in the
                  Czech Republic. Delivery abroad is used by the company Zásilkovna s.r.o. ( Packeta Group) – which uses
                  external foreign carriers for the delivery of parcels (eg DE HERMES, AT DPD, BG SPEEDY, GB FEDEX, GR
                  SPEEDEX and others)
                </li>
              </ol>
            </li>
            <li>
              The costs of delivering the goods, depending on the method of sending and receiving the goods, are indicated
              in the buyer's order and in the seller's confirmation of the order. In the event that the mode of transport
              is contracted on the basis of a special request of the buyer, the buyer bears the risk and any additional
              costs associated with this mode of transport.
            </li>
            <li>
              If, according to the purchase contract, the seller is obliged to deliver the goods to the place specified by
              the buyer in the order, the buyer is obliged to take over the goods upon delivery. If, for reasons on the
              part of the buyer, it is necessary to deliver the goods repeatedly or in a different way than was specified
              in the order, the buyer is obliged to pay the costs associated with repeated delivery of the goods, or costs
            ...
            <li>
              ...
              packaging of the goods and, in the event of any defects, to notify the transporter immediately. In the event
              of a violation of the packaging indicating an unauthorized intrusion into the shipment, the buyer does not
            ...
            <li>
              ...
              including delivery costs, but first by taking over the goods. Liability for accidental destruction, damage
              or loss of goods passes to the buyer at the time of acceptance of the goods or at the time when the buyer
          ...
          <ol>
            <li>
              A buyer who concluded a purchase contract outside of his business activity as a consumer has the right to
            ...
            <li>
              ...
              <ol>
                ...
                <li>
                  from the date of acceptance of the last delivery of goods, if the subject of the purchase contract is
                  several types of goods or the delivery of several parts,
                </li>
                <li>
                  from the date of acceptance of delivery of goods, if the subject of the purchase contract is regular or
            ...
            <li>
              Withdrawal from the purchase contract must be sent to the seller within the period specified in the previous
            ...
            <li>
              Due to the nature of the goods, in case of withdrawal from the contract, the buyer is obliged to return the
              goods to the seller in undamaged packaging.

            </li>
            <li>
              By withdrawing from the purchase contract, it is canceled from the beginning. The goods must be returned to
              the buyer and seller no later than fourteen (14) days after delivery of the withdrawal from the purchase
              contract to the seller. If the buyer withdraws from the purchase contract, the buyer bears the costs
              associated with returning the goods to the seller, even if the goods cannot be returned by the usual postal
              route due to their nature.

            </li>
            <li>
              In the event of the buyer's withdrawal from the contract, the seller is obliged to return the money to the
              buyer immediately, but no later than within 14 days of the withdrawal from the contract, the funds spent by
              the buyer on the goods and on the cheapest offered method of delivery of the goods from the online store.
              The money will be returned in the same way as it was received, or by transfer to the buyer's account, unless
              the parties agree otherwise.

            </li>

            <li>
              If the buyer has chosen a different method of delivery of the goods than the cheapest method offered by the
              seller, the seller will refund the cost of delivery of the goods to the buyer in the amount corresponding to
              the cheapest method of delivery of the goods offered.
            </li>

            <li>
              The seller is not obliged to return to the buyer all funds spent according to Article VI. paragraph 6 of the
              General Terms and Conditions before the buyer hands over the goods to him or proves that he has sent the
              goods to the seller.

            </li>
            <li>
              The seller is entitled to unilaterally offset the claim for payment of damage caused to the goods against
              the buyer's claim for a refund of the purchase price.

            </li>

            <li>
              If a gift is provided to the buyer together with the goods, the gift contract, the subject of which is this
              gift, is concluded between the seller and the buyer with the severance condition that if the buyer withdraws
              from the purchase contract, the gift contract regarding such a gift ceases to be effective and the buyer
              obliged to return the given gift together with the goods to the seller. If the buyer does not return the
              provided gift within the period set by the seller, the seller has the right to continue to demand an amount
              corresponding to the value of the unreturned product.

            </li>

            <li>
              In the event that other goods are sold together with the goods at a highly discounted promotional price
              (e.g. CZK 1), it is considered that the purchase contract, the subject of which is the discounted
              promotional goods, is concluded with a release clause, and if withdrawal from the purchase contract, the
              subject of which was the goods for which the goods were sold at a discounted promotional price, the purchase
              contract regarding the discounted promotional goods ceases to be effective and the buyer is obliged to
              return to the seller also the goods at a discounted promotional price and the seller returns to the buyer
              the purchase price of these discounted promotional goods . If the buyer does not return the goods at a
              highly discounted price within the period set by the seller, the seller has the right to continue to demand
              an amount corresponding to the actual value of the unreturned product.

            </li>

            <li>
              The buyer acknowledges that according to § 1837 letter d) of the Civil Code, he is not entitled to withdraw
          ...
          <ol>
            <li>
              The seller is entitled to withdraw from the purchase contract especially due to the stock being sold out,
              the unavailability of the goods, or when the manufacturer, importer or supplier of the goods has stopped the
              production or import of the goods or the price of the supplier of the goods has changed significantly, or it
              is not possible to deliver the goods to the seller from the seller's supplier at the originally stated
              price, also in case of an obvious error in the price of the goods (i.e. prices clearly different from the
              usual price for this type/type of goods).

            </li>
            <li>
              For example, the wrong indication of the first three digits instead of four is considered obvious in the
              price of the goods; a lower price by one digit (e.g. one digit "drops out" when specifying the price); an
              obviously low price of the goods (e.g. a 50% lower price than is usual for this kind and type of goods,
              without indicating that the goods are a sale or another discount event); and other obvious typographical
            ...
            <li>
              ...
              specified in the order and returns within fourteen (14) days from the notification of withdrawal from the
              purchase contract all funds, including delivery costs, that he received from the buyer on the basis of the
          ...
          <ol>
            <li>
              The rights and obligations of the contracting parties regarding rights from defective performance are
              governed by Sections 1914 to 1925, Sections 2099 to 2117 and Sections 2161 to 2174 of the Civil Code and
              Act No. 634/1992 Coll., on consumer protection.

            </li>
            <li>
              The seller is responsible to the buyer that the goods are free of defects upon receipt. In particular,
              the seller is responsible to the buyer that at the time the buyer took over the goods:
              <ol>
                <li>
                  the goods have the properties agreed upon by the parties and, in the absence of an agreement, they
                  have the properties that the seller or manufacturer has described or that the buyer expected with
                  regard to the nature of the goods and on the basis of the advertising carried out by them,

                </li>
                <li>
                  the goods are suitable for the purpose that the seller states for their use or for which goods of
                  this type are usually used,
                </li>
                <li>
                  the quality or design of the goods corresponds to the contracted sample or model, if the quality or
            ...
            <li>
              The seller's liability for defects does not apply to wear and tear caused by normal use and to goods sold at
              a lower price for a defect for which a lower price was agreed.
            </li>
            <li>
              In accordance with § 2104 of the Civil Code, the buyer is obliged to inspect the goods as soon as possible
              after taking them over and make sure of their properties and quantity.
            </li>
            <li>
              The period for asserting rights from defective performance begins on the day the buyer takes over the goods,
              i.e. the day indicated on the purchase document.

            </li>
            <li>
              If a defect becomes apparent within six (6) months of receipt, it is considered that the goods were already
            ...
            <li>
              If the goods, on their packaging, in the instructions attached to the goods or in advertising, in accordance
              with other legal regulations, the period during which the goods can be used is indicated, the provisions on
              the quality guarantee shall apply. With a quality guarantee, the seller undertakes that the goods will be
              suitable for use for the usual purpose or that they will retain their usual properties for a certain period
              of time. If the buyer justifiably accuses the seller of a defect in the goods, the period for exercising
              rights from defective performance or the warranty period does not run for the period during which the buyer
              cannot use the defective goods.

            </li>
            <li>
              Rights from defective performance are asserted by the buyer with the seller in person at the seller's
              registered office, in writing at the address of the registered office, in person at the warehouse located at
              Kulkova 8, 615 00 Brno during delivery hours (Monday to Thursday from 1:00 p.m. to 4:00 p.m. and Friday from
              11:00 a.m. to 14.00).

            </li>
            <li>
              Other rights and obligations of the parties related to the seller's liability for defects are regulated in
          ...
          <ol>
            <li>
              In the sense of § 1820 paragraph 1 letter j) of the Civil Code and § 14 paragraph 1 and § 20d et seq. of Act
              No. 634/1992, for the protection of the consumer, the seller informs that with a proposal for an
              out-of-court settlement of a consumer dispute, the consumer can turn to the body for out-of-court settlement
              of consumer disputes, which is the Czech Trade Inspection, with its registered office at Štěpánská 567/15,
              120 00 Prague 2, Identification number: 000 20 869, on the website www.coi.cz. The Czech Trade Inspection
            ...
            <li>
              For the avoidance of doubt, no provision of these terms and conditions precludes the consumer from taking
          ...
          <ol>
            <li>
              All arrangements between the seller and the buyer are governed by the legal order of the Czech Republic. If
              the relationship established by the purchase contract contains an international element, then the parties
              agree that the relationship is governed by the law of the Czech Republic. This does not affect consumer
              rights arising from generally binding legal regulations
            </li>
            <li>
              The seller declares that he is not bound by any codes of conduct in relation to the buyer in the sense of
              the provisions of § 1826 paragraph 1 letter e) of the Civil Code.
            </li>
            <li>
              All rights to the seller's online store, in particular copyright to the content, including page layout,
              photos, films, graphics, trademarks, logos and other content and elements, belong to the seller. It is
              forbidden to copy, modify or otherwise use the website or part of it without the consent of the seller.

            </li>
            <li>
              The seller is not responsible for errors arising as a result of interventions by third parties in the online
              store or as a result of its use contrary to its purpose. When using the online store, the buyer must not use
              procedures that could have a negative effect on its operation and must not perform any activity that could
              allow him or third parties to interfere or use the software or other components that make up the online
              store and use the online store without authorization, or its parts or software equipment in such a way that
              would be contrary to its purpose or purpose.

            </li>
            <li>
              The buyer hereby assumes the risk of a change in circumstances within the meaning of § 1765, paragraph 2 of
              the Civil Code.
            </li>
            <li>
              The general terms and conditions are attached to the complaints procedure and a model form for withdrawing
